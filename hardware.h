...
#define NUM_B 4//number of boards
...
const int boardMap[NUM_B] = {3,2,1,0};//{3,4,5,6};//{3,2,1,0};   % new board map feb 2020,  6-->0,  5-->1,  4-->2,  3-->3
...
// these output currents are not used anymore
const int loopsize = 2;
float output_currents[loopsize][40] =
{
  ...
  {0.00, -0.02, -0.00, 0.33, -0.02, 0.03, -0.09, -0.12, 0.25, 0.80, 0.80, 2.00, 0.09, -2.00, 0.06, 0.08, -0.11, -0.04, 0.24, -0.03, -0.19, 0.61, -0.08, -0.00, -0.05, 0.12, -0.30, 0.24, -0.04, -0.33, -0.06, 0.04,},
};
/******************************************************/
/*********************** PROTOTYPES *******************/
/******************************************************/
